...
G)});/*! Copyright (c) 2013 Brandon Aaron (http://brandon.aaron.sh)
...
1));if("object"===typeof d||!d)return y.init.apply(this,arguments)};d.fn.removeStyle=function(e){return this.each(function(){var c=d(this);e=e.replace(/\s+/g,"");var l=e.split(",");d.each(l,function(){var b=RegExp(this.toString()+"[^;]+;?","g");c.attr("style",function(a,c){if(c)return c.replace(b,"")})})})}})(jQuery);!function(s){"use strict";function e(s){return new RegExp("(^|\\s+)"+s+"(\\s+|$)")}function n(s,e){var n=a(s,e)?c:t;n(s,e)}var a,t,c;"classList"in document.documentElement?(a=function(s,e){return s.classList.contains(e)},t=function(s,e){s.classList.add(e)},c=function(s,e){s.classList.remove(e)}):(a=function(s,n){return e(n).test(s.className)},t=function(s,e){a(s,e)||(s.className=s.className+" "+e)},c=function(s,n){s.className=s.className.replace(e(n)," ")});var i={hasClass:a,addClass:t,removeClass:c,toggleClass:n,has:a,add:t,remove:c,toggle:n};"function"==typeof define&&define.amd?define(i):s.classie=i}(window);
...
;!function(){var e=this,t=Object.prototype.toString,n={},r=/(seconds?|secs?|^([0-9]+)s)/i,s=/(minutes?|mins?|^([0-9]+)m)/i,c=/(hours?|hrs?|^([0-9]+)h)/i,u=function(e){return"[object Number]"==t.call(e)},a=function(e){return"[object String]"==t.call(e)},i=function(e){return"[object Boolean]"==t.call(e)},l=function(e){return"[object Array]"==t.call(e)},o=function(e){var t=/(seconds?|secs?|^([0-9]+)s|minutes?|mins?|^([0-9]+)m|hours?|hrs?|^([0-9]+)h)/i;return u(e)||t.test(e)},f=function(e){e=e.split(" ");var t=0,n="";return e.length>1?(t=parseFloat(e[0]),n=e[1]):(t=parseFloat(e),r.test(e)?n="seconds":s.test(e)?n="minutes":c.test(e)&&(n="hours")),r.test(n)?1e3*t:s.test(n)?6e4*t:c.test(n)?36e5*t:t};e.wait=function(e,t,r){var s=0;return e=u(e)?e:f(e),s=setTimeout(t,e),r&&a(r)&&(n[r]=s),s},e.repeat=function(e,t,r,s){var c=0;return e=u(e)?e:f(e),3===arguments.length&&i(r)&&(s=r),s&&t(),c=setInterval(t,e),r&&a(r)&&(n[r]=c),c},e.until=function(t,n,r,s){if(t())return void n();3===arguments.length?o(r)||u(r)?(r=r,r=u(r)?r:f(r)):(s=r,r=100):4===arguments.length?(r=r||100,r=u(r)?r:f(r)):r=100;var c=e.repeat(r,function(){t()&&(e.clear(c),n())},s,!1);return c},_clear=function(e){clearInterval(e),clearTimeout(e)},e.clear=function(e){var t=[],r="";if(0===arguments.length)for(e in n)_clear(n[e]),delete n[e];else if(l(e)||a(e)){t=l(e)?e.slice():[e];for(var s=0;s<t.length;s++)r=t[s],a(r)?(_clear(n[r]),delete n[r]):_clear(r)}else _clear(e)}}();
;jQuery(document).ready(function(){"use strict";new BoxesFx(document.getElementById("boxgallery")),jQuery(document).ready(function(e){var n=4;repeat(2e3,function(){4==n?(e("#boxgallery nav span:nth-child(0)").click(),n=2):(e("#boxgallery nav span:nth-child("+n+")").click(),n+=1)})})});
;function modalshow(e){$(e).modal("show")}function Animation(e,n,a){$(e).delay(a).removeClass().addClass(n+" animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){$(this).removeClass()})}function Animation(e,n,a){$(e).delay(a).removeClass().addClass(n+" animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){$(this).removeClass()})}function Homepage_Animation(){$("#mainheader").show("fade",{easing:"easeInQuad"},menu_main_header_speed),Animation("#mainheader","fadeInUp","200"),Animation("#spmenu1","fadeInRight","300"),Animation("#spmenu2","fadeInRight","800"),Animation("#spmenu3","fadeInRight","5000"),Animation("#1","fadeInLeft","800"),Animation("#2","fadeInUp","1800"),Animation("#3","fadeInDown","800"),Animation("#4","fadeInLeft","1800"),Animation("#5","fadeInRight","800")}function Subpage_animation(){Animation("#header","fadeInDown","200"),$("#header").show("fade",{direction:"top",easing:"easeInQuad"},menu_header_speed)}function resizePanel(){width=$(window).width(),height=$(window).height(),mask_width=width*$(".item").length,$("#debug").html(width+" "+height+" "+mask_width),$("#wrapper, .item").css({width:width,height:height}),$("#mask").css({width:mask_width,height:height}),$("#wrapper").scrollTo($("a.selected").attr("href"),0)}var color="#9E2811",saturation=100,mapLatitude=38.9076858,mapLongitude=-77.063863,mapZoom_value=16,marker1_Latitude=38.9076858,marker1_Longitude=-77.063863,marker1_pointerUrl="assets/img/map-marker.png",horizontal_scroll_speed=1500,menu_header_speed=300,menu_main_header_speed=600,niceScrollcursorcolor="#f32a2a",niceScrollcursorborder="0";jQuery(document).ready(function(e){"use strict";e("a.nav-link").click(function(e){e.preventDefault()});var n=window.location.href,a=n.split("#"),o="";if(a.length>1&&(o=a[1]),""!=o){var i="#"+o;e("a[href='"+i+"']").addClass("selected"),"#home"==i?(e("#header").hide("fade",{direction:"left",easing:"easeInQuad"},1e3),Animation("#header","fadeOutUp","200")):(e("#mainheader").hide("fade",{direction:"left",easing:"easeInQuad"},600),Animation("#mainheader","fadinUp","200")),e("#wrapper").scrollTo(i,2e3,{easing:"easeInOutExpo",axis:"x",onAfter:function(){"#home"!=i&&e("#header").is(":hidden")&&Subpage_animation()}})}e("a.nav-link").click(function(){var n=e(this).attr("href");"#"!=n&&("#home"==n?(e(".selected").removeClass("selected"),e("a[href='"+n+"']").addClass("selected"),e("#header").hide("fade",{direction:"left",easing:"easeInQuad"},1e3),Animation("#header","fadeOutUp","200")):""!=n&&(e(".selected").removeClass("selected"),e("a[href='"+n+"']").addClass("selected"),e("#mainheader").hide("fade",{direction:"left",easing:"easeInQuad"},600),Animation("#mainheader","fadinUp","200")),e("#wrapper").scrollTo(e(this).attr("href"),horizontal_scroll_speed,{easing:"easeInOutExpo",axis:"x",onAfter:function(){"#home"==n?(Homepage_Animation(),e("a[href='#home']").addClass("selected")):e("#header").is(":hidden")&&Subpage_animation()}}))})}),$(window).bind("hashchange",function(){var e=window.location.href,n=e.split("#"),a="";if(n.length>1&&(a=n[1]),""!=a){var o="#"+a;"#home"==o?($("#header").hide("fade",{direction:"left",easing:"easeInQuad"},1e3),Animation("#header","fadeOutUp","200")):($("#mainheader").hide("fade",{direction:"left",easing:"easeInQuad"},600),Animation("#mainheader","fadinUp","200")),$("#wrapper").scrollTo(o,2e3,{easing:"easeInOutExpo",axis:"x",onAfter:function(){"#home"==o?Homepage_Animation():$("#header").is(":hidden")&&Subpage_animation()}})}}),jQuery(document).ready(function(e){"use strict";window.onhashchange=function(){e(".selected").removeClass("selected");var n=window.location.hash;""!=n&&e("a[href='"+n+"']").addClass("selected")},e("#header ul.nav li a").click(function(){e("ul.nav li a").removeAttr("class"),e(this).attr("class","nav-link selected")}),e(function(){e("#sub-nav").slicknav({label:"",duration:1e3,easingOpen:"easeOutQuint",closeOnClick:!0})})}),jQuery(function(e){e(".accura-jump a,.accura-jump-bg a").each(function(){var n=e(this);n.append(n.find("i").clone())}),e(".accura-social-icons-big a i").wrap("<span></span>")}),jQuery(document).ready(function(e){"use strict";e(window).resize(function(){resizePanel()})}),$(window).load(function(){function e(){a.removeClass().addClass(n.width()/n.height()<o?"bgheight":"bgwidth")}var n=$(window),a=$(".bg"),o=a.width()/a.height();n.resize(function(){e()}).trigger("resize")}),jQuery(document).ready(function(e){"use strict";e("#contact_form").validate({rules:{name:{minlength:2,required:!0},email:{required:!0,email:!0},message:{minlength:3,required:!0}},highlight:function(n){e(n).closest(".control-group").removeClass("success").addClass("error")},success:function(e){e.text("OK!").addClass("valid").closest(".control-group").removeClass("error").addClass("success")},submitHandler:function(){e.post("cgi-bin/contact_form.php",e("#contact_form").serialize(),function(n){e("#contact_form").html(n)})}})}),jQuery(document).ready(function(e){"use strict";function n(){{var e=new google.maps.LatLng(mapLatitude,mapLongitude),n=[{featureType:"landscape",stylers:[{hue:"#000"},{saturation:-100},{lightness:40},{gamma:1}]},{featureType:"road.highway",stylers:[{hue:color},{saturation:saturation},{lightness:20},{gamma:1}]},{featureType:"road.arterial",stylers:[{hue:color},{saturation:saturation},{lightness:-10},{gamma:1}]},{featureType:"road.local",stylers:[{hue:color},{saturation:saturation},{lightness:20},{gamma:1}]},{featureType:"water",stylers:[{hue:"#000"},{saturation:-100},{lightness:15},{gamma:1}]},{featureType:"poi",stylers:[{hue:"#000"},{saturation:-100},{lightness:25},{gamma:1}]}],a={center:e,zoom:mapZoom_value,zoomControlOptions:{position:google.maps.ControlPosition.LEFT_BOTTOM},panControlOptions:{position:google.maps.ControlPosition.LEFT_BOTTOM},styles:n},o=new google.maps.Map(document.getElementById("map_canvas"),a),i=new google.maps.LatLng(marker1_Latitude,marker1_Longitude),t={url:marker1_pointerUrl,scaledSize:new google.maps.Size(39,68)};new google.maps.Marker({position:i,map:o,icon:t})}}var a;a=e(window).width()<796?!1:!0,window.onload=function(){n()}}),jQuery(document).ready(function(e){"use strict";e(".spmenu1, .spmenu2, .spmenu3, .spmenu4").hover(function(){e(this).addClass("forefront")},function(){e(this).removeClass("forefront")})}),$(document).ready(function(){"use strict";$(".toggle-content").hide(),$(".toggle-link").click(function(){return $(this).is(".toggle-close")?($(this).removeClass("toggle-close").addClass("toggle-open").parent().next(".toggle-content").slideToggle(300),$("#scrolldynamic").getNiceScroll().resize(),!1):($(this).removeClass("toggle-open").addClass("toggle-close").parent().next(".toggle-content").slideToggle(300),$(".menuscroll").getNiceScroll().resize(),$("#scrolldynamic").getNiceScroll().resize(),!1)})}),$(document).ready(function(){"use strict";$(".contentscroll").niceScroll({cursorcolor:niceScrollcursorcolor,touchbehavior:!0,scrollspeed:160,mousescrollstep:90,smoothscroll:!0,cursorwidth:"6px",cursorborder:"0",cursordragontouch:!0}),$("#menutop").niceScroll({cursorcolor:niceScrollcursorcolor,touchbehavior:!0,scrollspeed:140,mousescrollstep:90,smoothscroll:!0,cursorwidth:"6px",cursorborder:"0",cursordragontouch:!0}),$(".contentscroll").mouseover(function(){$(".contentscroll").getNiceScroll().resize()})}),jQuery(document).ready(function(e){"use strict";e("body").jpreLoader({splashID:"#jSplash",showPercentage:!0,autoClose:!0,showSplash:!0,splashFunction:function(){e("#circle").delay(1250).animate({opacity:1},700,"linear")}})});
;
